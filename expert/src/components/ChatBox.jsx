...
export default function ChatBox({ currentUserId, otherUserId, onClose, addNotification, token }) {
  ...
  const fetchMessages = async () => {
    try {
      ...
      const res = await api.getMessages(token, otherUserId);
      if (res && res.data) {
  ...
  const handleSend = async (e) => {
    ...
    try {
      await api.sendMessage(token, otherUserId, msgContent);
      fetchMessages();
    } catch (error) {
